...
import jonsthan.ramirez.Max.proyectoformativo.EXPEDIENTE_PACIENTE
...
class ADAPTADOR(private var Data: List<PACIENTES>) : RecyclerView.Adapter<ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.activity_item_card_paciente, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, posicion: Int) {
        ...
        holder.btnVerInformacion.setOnClickListener{
            ...
            val Expediente = Intent(context,EXPEDIENTE_PACIENTE::class.java)
